module mod_DE_import

  implicit none

  private
  public :: Attributes, read_entity_Attributes
  ...
  contains
    procedure :: read      => read_entity_Attributes
  end type Attributes

contains

  subroutine read_entity_Attributes(this, fileunit, &
                                    num_record_start)
    class(Attributes)    :: this
  ...
  end subroutine read_entity_Attributes


end module mod_DE_import
